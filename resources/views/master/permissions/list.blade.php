                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <a href="{{route('master.permissions')}}">
                            <div class="card border-bottom border-3 card-animate border-success" style="background-color: #2b3030;">
                                <div class="card-body">
                                    <h4 class="mb-4 text-reset" ><span style="color:white" class="counter-value" data-target="8541">0</span></h4>
                                        ...
                                        <div class="row align-items-center g-2">
                                            ...
                                            <div class="col-lg-auto">
                                                <div class="hstack flex-wrap gap-2">
                                                    ...
                                                    <a href="#addCourse" data-bs-toggle="modal" class="btn btn-secondary"><i class="bi bi-plus-circle align-baseline me-1"></i> Add Permission</a>
                                                    <!-- <div>
                                            ...
                                            <table class="table table-centered align-middle table-custom-effect table-nowrap mb-0">
                                                <thead class="text-muted">
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="sort cursor-pointer" data-sort="role_id">Permission ID</th>
                                                        <th scope="col" class="sort cursor-pointer" data-sort="role_name">Permission Name</th>
                                                        <th scope="col" class="sort cursor-pointer" data-sort="role_description">Description</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td class="sno">1</td>
                                                        <td class="role_id fw-medium link-primary">#TBS001</td>
                                                        <td class="role_name">React Development</td>
                                                        <td class="role_description">Themesbrand</td>
